...
const LoggedInNavBar = props => {
    ...
    const style = {
        '@media (min-width: 500px)': {
            display: 'inline-block', backgroundColor: 'green', float:'left', paddingLeft: '10px'
        },
        '@media (max-width: 499px)': {
            display: 'inline-block', backgroundColor: 'goldenrod', float:'left', paddingLeft: '10px'
        }
    }
