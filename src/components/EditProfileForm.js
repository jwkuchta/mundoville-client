...
class EditProfileForm extends Component {
    ...
    //         switch (target) {
    //             case 'firstName':
    //                 return this.lastNameRef.current.lastChild.firstChild.focus()
    //             case 'lastName':
    //                 return this.yobRef.current.lastChild.firstChild.focus()
    //             case 'yob':
    //                 return this.bioRef.current.lastChild.focus()
    //             case 'bio':
    //                 return this.emailRef.current.lastChild.firstChild.focus()
    //             case 'email':
    //                 return this.passRef.current.lastChild.firstChild.focus()
    //             case 'password':
    //                 return this.passConfRef.current.lastChild.firstChild.focus()
    //             case 'passwordConf':
    //                 return this.countryRef.current.lastChild.firstChild.focus()
    //             case 'country':
    //                 return this.cityRef.current.lastChild.firstChild.focus()
    //             case 'city':
    //                 return this.occupationRef.current.lastChild.firstChild.focus()
    //             case 'occupation':
    //                 return this.lang1Ref.current.lastChild.firstChild.focus()
    //             case 'language1':
    //                 return this.lang2Ref.current.lastChild.firstChild.focus()
    //             case 'language2':
    //                 return this.lang3Ref.current.lastChild.firstChild.focus()
    //             case 'language3':
    //                 return this.submitRef.current.focus()
    //             default:
    //                 return this.firstNameRef.current.lastChild.firstChild.focus()
    //         }  
    //     }
    // }
