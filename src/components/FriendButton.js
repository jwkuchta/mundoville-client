...
//     const f1 = props.currentUser.user.friendships.filter(f => f.friend_id === props.user.id)
//     const f2 = props.user.friendships.filter(f => f.friend_id === props.currentUser.user.id)
