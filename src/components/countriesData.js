...
export const COUNTRY_OPTIONS = [
    ...
    // export const countries = COUNTRY_OPTIONS.map(country => Object.entries(country).reduce(([key, value]) => {
    //     if(key === 'flag') {
    //         value.toLowerCase()
    //     }
    // }))

    // let yemen = {"text":"Yemen","key":"YE","value":"YE","flag":"YE"}

    // export const countries = Object.entries(yemen).reduce(([key, value]) => {
    //     if(key === 'flag') {
    //         value.toLowerCase()
    //     }
    // })
    ...
    //     let newCountries = []
    //     let newCountry = {}
    //     Object.entries(country).reduce(([key, value]) => {
    //         if(key === 'flag') {
    //             newCountry[key] = value.toLowerCase()
    //         }
    //         else {
    ...
    // for (let [key, value] of Object.entries({"text":"Yemen","key":"YE","value":"YE","flag":"YE"})) {
    //     let newObj = {}
