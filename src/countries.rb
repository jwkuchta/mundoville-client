countries = [
    ...
    newCountries = countries.each do |country|
        country.each do |key, value|
            if key == 'flag'
                country[key] = country.key.downcase
            end
        end
    end
